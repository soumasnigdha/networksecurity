...
A demonstration of the application and its prediction functionality using the Swagger UI can be found here: 

![Application Demo](https://github.com/soumasnigdha/networksecurity/blob/main/network_security_demo.gif)
