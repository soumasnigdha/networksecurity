...
class DataTransformation:
  ...
  def get_data_transformer_object(cls)-> Pipeline:
    ...
    try:
      ...
      logging.info("Pipeline created with KNNImputer")
      return processor
    except Exception as e:
      raise NetworkSecurityException(e, sys)
  ...
  def initiate_data_transformation(self)->DataTransformationArtifact:
    ...
    try:
      ...
      ##Training dataframe
      input_features_train_df=train_df.drop(columns=["_id", TARGET_COLUMN], axis=1)
      target_feature_train_df=train_df[TARGET_COLUMN]
      target_feature_train_df = target_feature_train_df.replace(-1, 0)
      ##Testing dataframe
      input_features_test_df=test_df.drop(columns=["_id", TARGET_COLUMN], axis=1)
      ...
      ## Save the transformed data as numpy array and the preprocessor object
